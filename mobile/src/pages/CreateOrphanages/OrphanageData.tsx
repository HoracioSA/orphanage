...
// console.log(images)
 ...
 async function handleOrphanageSubmit(){
  try {
 ...
 async function handleSelectImage(){
    const{status}=await ImagePicker.requestCameraRollPermissionsAsync();
      if(status !== 'granted'){
        alert('You need to alow access to photo galery...');
        return;
      }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <Text style={styles.label}>Time for visiting</Text>
      <TextInput
        style={styles.input}
        value={opening_hours}
      ...
      <RectButton style={styles.nextButton} onPress={handleOrphanageSubmit}>
